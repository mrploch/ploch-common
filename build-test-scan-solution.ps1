param (
    ...
    [Parameter(Mandatory=$true)] [String] $sonarOrganization
)

write-host "Running .NET "
dotnet tool install --global dotnet-sonarscanner
dotnet tool install --global dotnet-coverage
dotnet restore Ploch.Common.sln
dotnet sonarscanner begin /k:$sonarProjectKey /o:$sonarOrganization /d:sonar.login="$sonarToken" /d:sonar.cs.opencover.reportsPaths=**/CoverageResults/coverage.opencover.xml /d:sonar.host.url="https://sonarcloud.io"
