...
namespace Ploch.Common.Data.GenericRepository
{
        ...
        where TEntity : class
    {
        ...
        /// <param name="cancellationToken">A <see cref="CancellationToken"/> to observe while waiting for the task to complete.</param>
        /// <returns>A task that represents the asynchronous operation. The task result contains a list of entities for the specified page.</returns>
    ...
    /// <summary>
    /// Defines a repository that provides asynchronous read operations for a collection of <see cref="TEntity"/> with a specified identifier type.
    /// </summary>
