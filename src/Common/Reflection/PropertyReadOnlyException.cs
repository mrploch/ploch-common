...
/// </remarks>
public class PropertyReadOnlyException : PropertyAccessException
{
    /// <summary>
    ...
    public PropertyReadOnlyException(string propertyName, string message, Exception? innerException = null) : base(propertyName, message, innerException)
    {
    }
}
