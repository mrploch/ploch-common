...
public static class TypeExtensions
{
  ...
  /// <summary>
  ///   Retrieves a human-readable name for the specified <see cref="System.Type" />, including details
  ///   about generic type arguments and array dimensions if applicable.
  /// </summary>
  /// <param name="t">The type for which to generate a readable name.</param>
  /// <returns>
  ///   A string representing the readable name of the type, including generic arguments and array indicators
  ///   (e.g., <c>List&lt;int&gt;</c>, <c>int[]</c>, or <c>Dictionary&lt;string, List&lt;int&gt;&gt;</c>).
  /// </returns>
  public static string GetReadableTypeName(this Type t)
  {
    ...
    {
      return GetReadableTypeName(elementType) + "[]";
    }
...
#pragma warning restore CA1865
                           string.Join(", ", t.GetGenericArguments().Select(GetReadableTypeName)));
