...
/// </remarks>
/// <remarks>
///     Initializes a new instance of the <see cref="WindowsManagementObjectEnumMappingAttribute" /> class.
///     Defines an attribute used for mapping enumeration fields to one or more string representations.
/// </remarks>
/// <remarks>
///     <para>
///         The <see cref="WindowsManagementObjectEnumMappingAttribute" /> can be applied to enumeration fields to associate their values
...
public sealed class WindowsManagementObjectEnumMappingAttribute(params string?[] names) : Attribute
{
    /// <summary>
    ///     Initializes a new instance of the <see cref="WindowsManagementObjectEnumMappingAttribute" /> class.
    ...
    ///     via the <see cref="WindowsManagementObjectEnumMappingAttribute" /> attribute
    ...
    /// </example>
    /// <seealso cref="WindowsManagementObjectEnumMappingAttribute" />
    ...
    ///     through the <see cref="WindowsManagementObjectEnumMappingAttribute" />.
    /// </summary>
    /// <remarks>
    ...
    ///     <see cref="WindowsManagementObjectEnumMappingAttribute" />. When set to <c>true</c>,
