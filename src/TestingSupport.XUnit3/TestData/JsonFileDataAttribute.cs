...
#pragma warning restore CC0023
{
    ...
    public override ValueTask<IReadOnlyCollection<ITheoryDataRow>> GetData(MethodInfo testMethod, DisposalTracker disposalTracker)
    {
        ...
        var readOnlyCollection = CastParamTypes(jsonData, testMethod).ToList().AsReadOnly();
...
#pragma warning disable CA1859 // Use concrete types when possible for improved performance - this is a signature of DataAttribute.
    private static IEnumerable<ITheoryDataRow> CastParamTypes(List<object?[]> jsonData, MethodBase testMethod)
#pragma warning restore CA1859
    {
        ...
        foreach (var paramsTuple in jsonData)
        {
            ...
            result.Add(new TheoryDataRow(paramValues));
        }
