...
public class TypeExtensionsTests
{
  ...
  private ITestGenericClassWithMultipleTypeArgs<TestClass1, TestClass2, TestGenericClass3<int>>[] _testArray = [];
...
#pragma warning restore CA2263
  ...
  [Theory]
  [InlineDataAttribute(typeof(TestGenericClassWithMultipleTypeArgs<TestClass1, TestClass2, TestGenericClass3<int>>),
                       "TestGenericClassWithMultipleTypeArgs<TestClass1, TestClass2, TestGenericClass3<Int32>>")]
  public void GetReadableTypeName_should_return_type_name_formatted_like_in_code_with_generic_types(Type testedType, string expectedTypeName)
  {
    var readableTypeName = testedType.GetReadableTypeName();
    readableTypeName.Should().Be(expectedTypeName);
  }
  ...
  public class TestGenericClassWithMultipleTypeArgs<TTestArg1, TTestArg2, TGenericTestArg>
    where TTestArg1 : TestClass1 where TTestArg2 : TestClass2 where TGenericTestArg : TestGenericClass3<int>
  { }

  public interface ITestGenericClassWithMultipleTypeArgs<TTestArg1, TTestArg2, TGenericTestArg>
    where TTestArg1 : TestClass1 where TTestArg2 : TestClass2 where TGenericTestArg : TestGenericClass3<int>
  { }
