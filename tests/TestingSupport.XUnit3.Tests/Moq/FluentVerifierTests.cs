...
namespace Ploch.TestingSupport.XUnit3.Tests.Moq;
    ...
    private static bool Verify(TestRecord1 actual, TestRecord1 expected) => FluentVerifier.VerifyFluentAssertion(() =>
                                                                                                                 {
                                                                                                                     ...
                                                                                                                     actual.IntProperty.Should()
                                                                                                                           .Be(expected.IntProperty);
                                                                                                                     actual.StringProperty.Should()
                                                                                                                           .Be(expected.StringProperty);
                                                                                                                 });

    private static bool Verify(TestRecord2 actual, TestRecord2 expected) => FluentVerifier.VerifyFluentAssertion(() =>
                                                                                                                 {
                                                                                                                     actual.RecordProperty1.BoolProperty
                                                                                                                           .Should()
                                                                                                                           .Be(expected.RecordProperty1
                                                                                                                                       .BoolProperty);
                                                                                                                     actual.RecordProperty1.IntProperty.Should()
                                                                                                                           .Be(expected.RecordProperty1
                                                                                                                                       .IntProperty);
                                                                                                                     actual.RecordProperty1.StringProperty
                                                                                                                           .Should()
                                                                                                                           .Be(expected.RecordProperty1
                                                                                                                                       .StringProperty);

                                                                                                                     actual.RecordProperty2.BoolProperty
                                                                                                                           .Should()
                                                                                                                           .Be(expected.RecordProperty2
                                                                                                                                       .BoolProperty);
                                                                                                                     actual.RecordProperty2.IntProperty.Should()
                                                                                                                           .Be(expected.RecordProperty2
                                                                                                                                       .IntProperty);
                                                                                                                     actual.RecordProperty2.StringProperty
                                                                                                                           .Should()
                                                                                                                           .Be(expected.RecordProperty2
                                                                                                                                       .StringProperty);
                                                                                                                 });
